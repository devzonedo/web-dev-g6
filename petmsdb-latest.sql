...
insert  into `tbl_pet`(`id`,`pet_name`,`category_id`,`dob`,`remark`,`owner_id`,`created_user`,`created_datetime`,`updated_user`,`updated_datetime`) values (1,'kitty',1,'10-12-2001',NULL,2,'2','2023-10-24 20:24:49',NULL,NULL),(2,'my tom',2,'10-12-2020','small dog',2,'2','2023-10-28 20:25:49',NULL,NULL),(3,'Rat',2,'10-12-2020','small dog',3,'3','2023-10-28 20:30:03',NULL,NULL);
...
insert  into `tbl_pet_category`(`id`,`category`) values (1,'CAT'),(2,'DOG');
